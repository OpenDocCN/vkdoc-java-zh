...
Print API 很大，但是很容易理解。这个方法只是触及了 API 的一些皮毛。一旦准备好开发自己的打印机流程，我们建议您通读 Javadoc 以获得更多详细信息。然而，这个食谱应该提供一个如何开始的基本理解。请参见 Javadoc 的以下链接:[`docs . Oracle . com/javase/8/Java FX/API/Java FX/print/package-summary . html`](http://docs.oracle.com/javase/8/javafx/api/javafx/print/package-summary.html)。
